...
def txt2csv():
    ...
    encode_info = get_encode_info("all_info.txt")
    if encode_info != 'utf-8':
        convert_encode2utf8("all_info.txt", encode_info, 'utf-8')
    csv_file = os.path.splitext("all_info.txt")[0] + '.csv'
    with open(csv_file, 'w+', newline='', encoding='utf-8') as csvfile:
        
        writer = csv.writer(csvfile, dialect='excel')
        with open("all_info.txt", 'r', encoding='utf-8') as txtfile:
